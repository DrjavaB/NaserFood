		...
		for (var i = 0; i < el.childNodes.length; i++) {
			...
			if (cnode.nodeType == 3) {
				...
				if (hasCommonElements(getClasses(cnode), persianNumClasses) || numberType === "p") {
					...
					jQuery(cnode).persianNum(
						{persianNumClasses: persianNumClasses, englishNumClasses: englishNumClasses, arabicNumClasses: arabicNumClasses, forbiddenTag: forbiddenTag}, "p");
				}
					...
					jQuery(cnode).persianNum(
						{persianNumClasses: persianNumClasses, englishNumClasses: englishNumClasses, arabicNumClasses: arabicNumClasses, forbiddenTag: forbiddenTag}, "e");
				}
					...
					jQuery(cnode).persianNum(
						{persianNumClasses: persianNumClasses, englishNumClasses: englishNumClasses, arabicNumClasses: arabicNumClasses, forbiddenTag: forbiddenTag}, "a");
				}
				jQuery(cnode).persianNum(
					{persianNumClasses: persianNumClasses, englishNumClasses: englishNumClasses, arabicNumClasses: arabicNumClasses, forbiddenTag: forbiddenTag});
			}
		}
